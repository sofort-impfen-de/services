...
type Booking struct {
	AppointmentID []byte                      `json:"appointmentID"`
...
findAppointment:
	...
	/*
		if result := c.verifyPermissions(context, transaction, params.Data.ProviderID, []string{"write"}, params.PublicKey, true); result != nil {
			return result
		}
